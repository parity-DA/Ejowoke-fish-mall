...
export default function Purchases() {
  ...
  const handleAddPurchase = async () => {
    if (!newPurchase.supplier_name || !newPurchase.total_amount) {
      toast({
  ...
  const totalRemainingValue = purchases.reduce((sum, purchase) => sum + purchase.total_amount, 0); // This would need proper calculation in real app
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Purchases & Stock</h1>
            ...
            <DialogContent className="sm:max-w-[600px]">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-end space-x-2 pt-4">
                  ...
                  <Button onClick={handleAddPurchase} className="bg-gradient-primary">
                    Add Purchase
                  </Button>
                </div>
              </div>
      ...
      <Card className="shadow-card">
        <CardHeader>
          ...
          <CardDescription>All recorded purchases from suppliers</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
